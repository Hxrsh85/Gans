...
save_dir = "/scratch/ep23btech11012.phy.iith/dc_gan_celeb/save_gen/"
...
for epoch in range(NUM_EPOCHS):
    ...
    g_loss_epoch = 0  # Initialize epoch loss for generator
    d_loss_epoch = 0
    ...
    # Calculate the average loss per epoch and store it
